...
# config
BASE_URL   = "https://mdcomputers.in/index.php?route=extension/ultimate_filters/module/filter&module_id=3188&category_id=73"
...
def get_product_urls():
    ...
    for page in range(1, MAX_PAGES + 1):
        ...
        links = [a["href"] for a in soup.select("div.products.elements-grid.product-products-holder a")]
        if not links:
            break                       
