'''
this script is written by claude ai to mimic the logic used in ingestion.py but for ram data instead of monitors.
It scrapes the same 2 websites (MD Computers and Prime ABGB) but goes to their RAM category pages, extracts product links,
